...
report/
  report.tex      LaTeX writeup (primary submission)
  report.pdf      compiled output (regenerated from .tex)
...
Then build the report PDF from the project root in a shell:

```bash
cd report && pdflatex report.tex && pdflatex report.tex
```

The two passes are needed so the table-of-contents and cross-references
resolve. The optional RMarkdown companion can be knit with
